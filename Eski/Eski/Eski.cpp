// Eski.cpp : Defines the entry point for the application.
//
...
int APIENTRY WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	if(RegOpenKeyExW(HKEY_LOCAL_MACHINE, L"Software\\Microsoft\\AppEnv\\14.0", 0, KEY_READ, &hKeyAppEnv11Hive) == ERROR_SUCCESS)
	{
		DWORD dwType;
	...
	nRetVal = StartWithCommandLine(lpwCmdLine, L"Eski", nCmdShow, NULL, NULL);
